 ...
 * @author HP
 */
public class DeletePostgraduateC extends javax.swing.JFrame {

    MySqlConnect sql=new MySqlConnect();
    Student2 st;
    
    public DeletePostgraduateC() {
        initComponents();
    }
    ...
    private void P_SubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_P_SubmitActionPerformed
        if(sql.deletePB(this.st)){
            StudentManagementCom smb=new StudentManagementCom();
            smb.loadStudents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeletePostgraduateC.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeletePostgraduateC().setVisible(true);
            }
        });
    }
